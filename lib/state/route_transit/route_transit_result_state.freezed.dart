...
mixin _$RouteTransitResultItemState {
  ...
  @JsonKey(ignore: true)
  $RouteTransitResultItemStateCopyWith<RouteTransitResultItemState>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $RouteTransitResultItemStateCopyWith<$Res> {
  factory $RouteTransitResultItemStateCopyWith(
          RouteTransitResultItemState value,
...
/// @nodoc
class _$RouteTransitResultItemStateCopyWithImpl<$Res,
        $Val extends RouteTransitResultItemState>
    implements $RouteTransitResultItemStateCopyWith<$Res> {
  _$RouteTransitResultItemStateCopyWithImpl(this._value, this._then);
...
class _$_RouteTransitResultItemState implements _RouteTransitResultItemState {
  ...
  @override
  String toString() {
    return 'RouteTransitResultItemState(latitude: $latitude, longitude: $longitude)';
  }
